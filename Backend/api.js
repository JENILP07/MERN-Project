...
//   const { email, password } = req.body;  // assuming role isn't needed for signin
...
//     // Send the user ID and role back to the client for further use
//     return res.status(200).json({ message: 'Login successful', id: user._id, role: user.role });
